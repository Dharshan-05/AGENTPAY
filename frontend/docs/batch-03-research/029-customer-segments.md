# 029 — CUSTOMER SEGMENTS RESEARCH BASELINE

## 1. TARGET DOMAIN
029 — CUSTOMER SEGMENTS

## 2. REPOSITORY SCORECARD
- **PRIMARY SOURCE**: Segment (Score: 97/100)
- **SECONDARY SOURCE**: PostHog (Score: 95/100)
- **TERTIARY SOURCE**: RudderStack (Score: 91/100)

## 3. EXCAVATED INFORMATION ARCHITECTURE
- Primary Resource Identifier: `SEG-AGP-001`
