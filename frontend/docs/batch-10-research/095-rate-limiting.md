# 095 — RATE LIMITING RESEARCH BASELINE
...
- **SECONDARY SOURCE**: Keycloak (Score: 96/100)
- **TERTIARY SOURCE**: Stripe OpenAPI (Score: 93/100)

## 4. EXCAVATED INFORMATION ARCHITECTURE
- Primary Resource Identifier: `RLIM-AGP-001`
