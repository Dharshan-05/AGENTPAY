# 097 — CHARGEBACK AUTO DEFENSE RESEARCH BASELINE

## 1. TARGET DOMAIN
097 — CHARGEBACK AUTO DEFENSE

## 2. PRODUCTION ROUTE
`/chargeback-auto-defense`

## 3. REPOSITORY SCORECARD
- **PRIMARY SOURCE**: Stripe OpenAPI (Score: 98/100)
- **SECONDARY SOURCE**: Juspay HyperSwitch (Score: 96/100)
- **TERTIARY SOURCE**: Adyen (Score: 93/100)

## 4. EXCAVATED INFORMATION ARCHITECTURE
- Primary Resource Identifier: `ADEF-AGP-001`
