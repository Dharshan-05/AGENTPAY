# 091 — TENANT ISOLATION RESEARCH BASELINE

## 1. TARGET DOMAIN
091 — TENANT ISOLATION

## 2. PRODUCTION ROUTE
`/tenant-isolation`

## 3. REPOSITORY SCORECARD
- **PRIMARY SOURCE**: Keycloak (Score: 98/100)
- **SECONDARY SOURCE**: Frappe Framework (Score: 96/100)
- **TERTIARY SOURCE**: Odoo (Score: 93/100)

## 4. EXCAVATED INFORMATION ARCHITECTURE
- Primary Resource Identifier: `TNT-AGP-001`
