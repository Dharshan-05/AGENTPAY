...
import { CatalogMethodTypeRecord } from './payment-method-types';
import { AGBadge } from '@/components/ui/ag-badge';

interface PaymentMethodCatalogProps {
  types: CatalogMethodTypeRecord[];
}

export function PaymentMethodCatalog({ types }: PaymentMethodCatalogProps) {
  return (
