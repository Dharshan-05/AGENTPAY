...
import { PaymentMethodAuditEvent } from './payment-method-types';
import { Lock } from 'lucide-react';

interface PaymentMethodAuditProps {
  entries: PaymentMethodAuditEvent[];
}

export function PaymentMethodAudit({ entries }: PaymentMethodAuditProps) {
  return (
