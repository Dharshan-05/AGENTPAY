...
export const PRODUCTION_INSTRUMENTS: PaymentInstrumentRecord[] = [
  {
...
export const PRODUCTION_CATALOG_TYPES: CatalogMethodTypeRecord[] = [
...
export const PRODUCTION_PROCESSOR_MATRIX: ProcessorCapabilityRecord[] = [
...
export const PRODUCTION_ROUTING_DECISIONS: RoutingDecisionRecord[] = [
  { id: 'rt_1', methodId: 'PM-AGP-001', methodName: 'Corporate Purchasing Visa', agentId: 'AGT-892', requestedCurrency: 'USD', requestedCountry: 'US', riskScore: 12, selectedProcessor: 'Stripe (Primary)', fallbackProcessor: 'Adyen', status: 'OPTIMAL', latencyMs: 31, healthScore: 99.98, decisionReason: 'Lowest cost + 99.98% auth rate in US region', timestamp: '2026-08-30 09:14:00' },
  { id: 'rt_2', methodId: 'PM-AGP-002', methodName: 'JPMorgan Operating Direct', agentId: 'AGT-441', requestedCurrency: 'USD', requestedCountry: 'US', riskScore: 8, selectedProcessor: 'JPMorgan Direct', fallbackProcessor: 'Citibank Direct', status: 'OPTIMAL', latencyMs: 195, healthScore: 100.0, decisionReason: 'Direct ACH rail routing zero interchange fee', timestamp: '2026-08-30 08:50:00' },
  { id: 'rt_3', methodId: 'PM-AGP-003', methodName: 'India Corporate VPA', agentId: 'AGT-118', requestedCurrency: 'INR', requestedCountry: 'IN', riskScore: 38, selectedProcessor: 'Razorpay (Primary)', fallbackProcessor: 'Adyen India', status: 'OPTIMAL', latencyMs: 310, healthScore: 98.8, decisionReason: 'Native NPCI UPI connector with instant settlement', timestamp: '2026-08-30 07:15:00' },
  { id: 'rt_4', methodId: 'PM-AGP-004', methodName: 'Ephemeral Single-Use Mastercard', agentId: 'AGT-990', requestedCurrency: 'EUR', requestedCountry: 'DE', riskScore: 68, selectedProcessor: 'Adyen (Fallback)', fallbackProcessor: 'Stripe Europe', status: 'FALLBACK', latencyMs: 520, healthScore: 94.2, decisionReason: 'Stripe 3DS challenge timeout -> Switched to Adyen', timestamp: '2026-08-30 06:00:00' },
  { id: 'rt_5', methodId: 'PM-AGP-011', methodName: 'Google Pay Business Vault', agentId: 'AGT-301', requestedCurrency: 'USD', requestedCountry: 'US', riskScore: 88, selectedProcessor: 'BLOCKED', fallbackProcessor: 'NONE', status: 'BLOCKED', latencyMs: 0, healthScore: 0, decisionReason: 'FraudGuard critical anomaly score (88/100) -> Route terminated', timestamp: '2026-08-26 12:00:00' }
];

export const PRODUCTION_SECURITY_RECORDS: SecurityPostureRecord[] = [
...
export const PRODUCTION_RISK_RECORDS: MethodRiskRecord[] = [
...
export const PRODUCTION_AUDIT_LOG: PaymentMethodAuditEvent[] = [
