...
export const MOCK_SOURCE_ENDPOINTS: WebhookEndpoint[] = [
  {
  ...
  {
    id: 'whk_4', endpointId: 'WHK-004', name: 'Sandbox Integration Test Receiver',
...
export const MOCK_SOURCE_EVENTS: WebhookEventRecord[] = [
  {
...
export const MOCK_SOURCE_DELIVERIES: WebhookDeliveryRecord[] = [
  {
    ...
    payloadJson: MOCK_SOURCE_EVENTS[0].payloadJson,
  ...
  },
  {
    ...
    payloadJson: MOCK_SOURCE_EVENTS[1].payloadJson,
  ...
  },
  {
    ...
    payloadJson: MOCK_SOURCE_EVENTS[2].payloadJson,
  ...
  },
  {
    ...
    requestHeaders: 'Content-Type: application/json',
    payloadJson: MOCK_SOURCE_EVENTS[3].payloadJson,
...
export const MOCK_SOURCE_SUBSCRIPTIONS: WebhookSubscription[] = [
  ...
  { id: 'sub_6', subscriptionId: 'SUB-006', endpointId: 'WHK-004', endpointName: 'Sandbox Integration Test Receiver', eventPattern: '*', environment: 'SANDBOX', filterRule: 'ALL_EVENTS', status: 'ACTIVE', createdTimestamp: '2026-04-12', lastTriggered: '1m ago' },
...
export const MOCK_SOURCE_RETRIES: WebhookRetrySchedule[] = [
...
export const MOCK_SOURCE_SECURITY: WebhookSecurityRecord[] = [
...
export const MOCK_SOURCE_AUDIT: WebhookAuditEvent[] = [
