...
import { SecurityPostureRecord } from './source-types';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-white/[0.08] backdrop-blur-xl space-y-2">
          <div className="flex items-center gap-2 text-emerald-400 font-bold text-xs">
            <ShieldCheck className="w-4 h-4" /> PCI-DSS OUT-OF-SCOPE VAULTING
          </div>
          <p className="text-[11px] text-slate-400 font-sans">
            Zero raw card numbers stored. All payment methods tokenized via EMVCo network tokens.
          </p>
        </div>

        <div className="p-4 rounded-2xl bg-slate-900/60 border border-white/[0.08] backdrop-blur-xl space-y-2">
          <div className="flex items-center gap-2 text-blue-400 font-bold text-xs">
            <Lock className="w-4 h-4" /> ENCLAVE HSM ENCRYPTION
          </div>
          <p className="text-[11px] text-slate-400 font-sans">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-white/[0.08] backdrop-blur-xl space-y-2">
          <div className="flex items-center gap-2 text-purple-400 font-bold text-xs">
            <Key className="w-4 h-4" /> AUTOMATED NETWORK TOKEN ROTATION
          </div>
          <p className="text-[11px] text-slate-400 font-sans">
            Continuous token life-cycle management preventing auth drops upon card re-issuance.
          </p>
        </div>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-white/[0.08] text-[10px] text-slate-500 uppercase tracking-wider">
              ...
              <th className="px-4 py-3 font-semibold">mTLS</th>
