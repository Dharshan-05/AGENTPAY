// ============================================================
// AGENTPAY — PHASE 14A
// PAYMENT METHODS & PAYMENT METHOD OPERATIONS — SOURCE TYPES
// Research baseline type definitions
// ============================================================

export type PaymentMethodSourceTabType =
  | 'REGISTRY'
  | 'CATALOG'
  | 'CARDS_BANKS'
  | 'MATRIX'
...
export interface CatalogMethodTypeRecord {
  ...
  label: string;
  description: string;
  availability: 'PRODUCTION_READY' | 'STAGING_ONLY' | 'RESEARCH_SIMULATION';
...
export interface RoutingDecisionRecord {
  ...
  status: 'OPTIMAL_ROUTE' | 'FALLBACK_TRIGGERED' | 'ROUTE_BLOCKED';
  latencyMs: number;
  healthScore: number;
