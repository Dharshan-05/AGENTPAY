...
export function SourceRegistry({ instruments, onSelect }: SourceRegistryProps) {
  return (
      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-white/[0.08] text-[10px] text-slate-500 uppercase tracking-wider">
            <th className="px-4 py-3 font-semibold">METHOD ID</th>
            <th className="px-4 py-3 font-semibold">TYPE</th>
            <th className="px-4 py-3 font-semibold">DISPLAY NAME &amp; IDENTIFIER</th>
