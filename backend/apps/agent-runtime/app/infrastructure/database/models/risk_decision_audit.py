...
class RiskDecisionAudit(Base):
    ...
    policy_evaluation_id: Mapped[uuid.UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_risk_decision_audits_pol_eval_id_pol_evals",
            ondelete="RESTRICT",
        ),
        nullable=True,
    )
    ...
    fraud_prediction_id: Mapped[uuid.UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_risk_decision_audits_fraud_pred_id_fraud_preds",
            ondelete="RESTRICT",
        ),
        nullable=True,
    )
    security_violation_id: Mapped[uuid.UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_risk_decision_audits_sec_viol_id_sec_viols",
            ondelete="RESTRICT",
        ),
        nullable=True,
    )
    ...
    commerce_transaction_id: Mapped[uuid.UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_risk_decision_audits_ctxn_id_ctxns",
            ondelete="RESTRICT",
        ),
        nullable=True,
    )
    payment_transaction_id: Mapped[uuid.UUID | None] = mapped_column(
        ...
        ForeignKey(
            ...
            name="fk_risk_decision_audits_ptxn_id_ptxns",
            ondelete="RESTRICT",
        ),
        nullable=True,
    )
